...
type IncrementServiceClient interface {
	Increment(ctx context.Context, in *Value, opts ...grpc.CallOption) (*Value, error)
}
...
func (c *incrementServiceClient) Increment(ctx context.Context, in *Value, opts ...grpc.CallOption) (*Value, error) {
	out := new(Value)
...
type IncrementServiceServer interface {
	Increment(context.Context, *Value) (*Value, error)
...
func (UnimplementedIncrementServiceServer) Increment(context.Context, *Value) (*Value, error) {
...
func _IncrementService_Increment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IncrementServiceServer).Increment(ctx, req.(*Value))
	}
